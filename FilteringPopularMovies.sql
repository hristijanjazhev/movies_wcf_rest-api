...
N'{ 
  ...
  "results": [
    ...
    },
    {
      ...
      "adult": false,
      "overview": "The year is 2029. John Connor, leader of the resistance continues the war against the machines. At the Los Angeles offensive, Johns fears of the unknown future begin to emerge when TECOM spies reveal a new plot by SkyNet that will attack him from both fronts; past and future, and will ultimately change warfare forever.",
    ...
    },
    {
      ...
      "adult": false,
      "overview": "A sorority moves in next door to the home of Mac and Kelly Radner who have a young child. The Radners enlist their former nemeses from the fraternity to help battle the raucous sisters.",
 ...
 SELECT 
 JSON_VALUE(a.value, '$.id') as MovieId,
 JSON_VALUE(a.value, '$.original_title') as OriginalTitle,
 JSON_VALUE(a.value, '$.original_language') as OriginalLanguage,
 JSON_VALUE(a.value, '$.title') as Title,
 JSON_VALUE(a.value, '$.backdrop_path') as BackdropPath,
 JSON_VALUE(a.value, '$.popularity') as Popularity,
 JSON_VALUE(a.value, '$.vote_count') as VoteCount,
 JSON_VALUE(a.value, '$.video') as Video,
 JSON_VALUE(a.value, '$.vote_average') as VoteAverage,
 JSON_VALUE(a.value, '$.total_results') as TotalResults
 from OPENJSON(@json, '$.results') as a	

  SELECT * INTO PopularMovies
FROM OPENJSON(@json, '$.results')
WITH  (
        MovieId			    int           '$.id',
		OriginalTitle		nvarchar(64)  '$.original_title',
		OriginalLanguage	nvarchar(64)  '$.original_language',
		BackdropPath		nvarchar(max)  '$.backdrop_path',
		Popularity			nvarchar(64)	'$.popularity',
		VoteCount			nvarchar(32)	'$.vote_count',
		Video				nvarchar(64)	'$.video',
		VoteAverage			nvarchar(32)	'$.vote_average',
		TotalResults		nvarchar(64)	'$.total_results',
